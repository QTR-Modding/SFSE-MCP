...
namespace SFSEMenuFramework {
    ...
    namespace Model {
        ...
        static_assert(sizeof(WindowInterface) == 2 * sizeof(std::atomic<bool>));
        static_assert(offsetof(WindowInterface, IsOpen) == 0);
        static_assert(offsetof(WindowInterface, BlockUserInput) == sizeof(std::atomic<bool>));
        ...
        using RegisterEventFunction = int64_t (*)(EventCallback callback, float priority);
        using UnregisterEventFunction = void (*)(int64_t id);
        ...
        using RegisterHudElementFunction = int64_t (*)(HudElementCallback callback);
        using UnregisterHudElementFunction = void (*)(uint64_t id);
        using IsAnyBlockingWindowOpenedFunction = bool (*)();
        ...
        public:
            InputEvent(InputEventCallback callback) {
                static auto func = Internal::GetFunction<RegisterInputEventFunction>("RegisterInputEvent");
                if (func && callback) {
                    id = func(callback);
                }
            }
            ~InputEvent() {
                static auto func = Internal::GetFunction<UnregisterInputEventFunction>("UnregisterInputEvent");
                if (func && id != 0) {
                    func(id);
                }
            }
            ...
            [[nodiscard]] bool IsRegistered() const noexcept { return id != 0; }
        };
        ...
        public:
            Event(EventCallback callback, float priority = 0.0F) {
                static auto func = Internal::GetFunction<RegisterEventFunction>("RegisterEventPriority");
                if (func && callback) {
                    id = func(callback, priority);
                }
            }
            ~Event() {
                static auto func = Internal::GetFunction<UnregisterEventFunction>("UnregisterEvent");
                if (func && id != 0) {
                    func(id);
                }
            }
        ...
        public:
            HudElement(HudElementCallback callback) {
                static auto func = Internal::GetFunction<RegisterHudElementFunction>("RegisterHudElement");
                if (func && callback) {
                    id = func(callback);
                }
            }
            ...
            ~HudElement() {
                static auto func = Internal::GetFunction<UnregisterHudElementFunction>("UnregisterHudElement");
                if (func && id != 0) {
                    func(id);
                }
            }
    ...
    inline Model::WindowInterface* AddWindow(Model::RenderFunction rendererFunction, bool blockUserInput = true) {
        ...
        if (func) {
            ...
            if (result) {
                result->BlockUserInput = blockUserInput;
            }
            return result;
        }
        return nullptr;
    }
    inline Model::WindowInterface* AddWindowWithView(Model::RenderFunction rendererFunction, std::string viewName,
    ...
    inline Model::InputEvent* AddInputEvent(Model::InputEventCallback callback) {
        auto* result = new (std::nothrow) Model::InputEvent(callback);
    ...
    inline Model::HudElement* AddHudElement(Model::HudElementCallback callback) {
        auto* result = new (std::nothrow) Model::HudElement(callback);
        if (result && !result->IsRegistered()) {
            delete result;
            result = nullptr;
        }
    ...
    inline Model::Event* AddEvent(Model::EventCallback callback, float priority = 0.0F) {
        auto* result = new (std::nothrow) Model::Event(callback, priority);
        if (result && !result->IsRegistered()) {
            delete result;
            result = nullptr;
        }
    ...
    inline bool IsAnyBlockingWindowOpen() {
        static auto func =
            Model::Internal::GetFunction<Model::IsAnyBlockingWindowOpenedFunction>("IsAnyBlockingWindowOpened");
        if (func) {
            return func();
        }
        return false;
    ...
    inline bool IsAnyBlockingWindowOpened() {
        return IsAnyBlockingWindowOpen();
    }
...
namespace FontAwesome {
    inline void PushSolid() {
        static auto func =
            SFSEMenuFramework::Model::Internal::GetFunction<SFSEMenuFramework::Model::ActionFunction>("PushSolid");
        if (func) {
            return func();
        }
    }
    inline void PushRegular() {
        static auto func =
            SFSEMenuFramework::Model::Internal::GetFunction<SFSEMenuFramework::Model::ActionFunction>("PushRegular");
        if (func) {
            return func();
        }
    }
    inline void PushBrands() {
        static auto func =
            SFSEMenuFramework::Model::Internal::GetFunction<SFSEMenuFramework::Model::ActionFunction>("PushBrands");
        if (func) {
            return func();
        }
    }
    inline void Pop() {
        static auto func =
            SFSEMenuFramework::Model::Internal::GetFunction<SFSEMenuFramework::Model::ActionFunction>("Pop");
        if (func) {
            return func();
        }
    }
...
#define IM_COL32(R, G, B, A)                                                                   \
    (((ImGuiMCP::ImU32)(A) << IM_COL32_A_SHIFT) | ((ImGuiMCP::ImU32)(B) << IM_COL32_B_SHIFT) | \
     ((ImGuiMCP::ImU32)(G) << IM_COL32_G_SHIFT) | ((ImGuiMCP::ImU32)(R) << IM_COL32_R_SHIFT))
...
#pragma endregion
    ...
    inline bool DragScalarN(const char* label, ImGuiDataType data_type, void* p_data, int components,
    ...
    inline bool ColorButton(const char* desc_id, const ImVec4 col, ImGuiColorEditFlags flags = 0,
    ...
    inline ImGuiID DockSpace(ImGuiID dockspace_id, const ImVec2 size = ImVec2(0, 0), ImGuiDockNodeFlags flags = 0,
    ...
    inline ImVec2 CalcTextSize(const char* text, const char* text_end = NULL, bool hide_text_after_double_hash = false,
    ...
    namespace ImFontManger {
        ...
        inline ImVec2 CalcTextSizeA(ImFont* self, float size, float max_width, float wrap_width, const char* text_begin,
    ...
    inline ImVec2 ImBezierCubicClosestPoint(const ImVec2 p1, const ImVec2 p2, const ImVec2 p3, const ImVec2 p4,
    ...
    inline ImVec2 ImBezierCubicClosestPointCasteljau(const ImVec2 p1, const ImVec2 p2, const ImVec2 p3, const ImVec2 p4,
    ...
    namespace ImGuiInputTextDeactivatedStateManager {
        inline ImGuiInputTextDeactivatedState* Create(void) {
            ...
            func_t func =
                GetMenuFrameworkFunction<func_t>("ImGuiInputTextDeactivatedState_ImGuiInputTextDeactivatedState");
            return func();
        }
    ...
    inline ImVec2 FindBestWindowPosForPopupEx(const ImVec2 ref_pos, const ImVec2 size, ImGuiDir* last_dir,
    ...
    // Hand-written wrappers not emitted by the generator.
...
namespace ImGuiMCPComponents {
    inline bool ToggleButton(const char* label, bool* v) {
        ...
        bool clicked =
            ImGuiMCP::Selectable(std::format("##toggle-{}", label).c_str(), false, 0, ImGuiMCP::ImVec2(width, height));
        ...
        ImGuiMCP::ImDrawListManager::AddCircleFilled(
            draw_list, ImGuiMCP::ImVec2(p.x + radius + t * (width - radius * 2.0f), p.y + radius), radius - 1.5f,
